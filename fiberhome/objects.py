...
class Response(DefaultResponse):
    ...
    Args:
        ...
        res_type (ResponseType, optional): The type of the response.
                                            Default is ResponseType.DEFAULT.
    ...
    """
    __slots__ = ('result')
    def __init__(self, header, identifier, text, terminator, res_type:Optional[ResponseType] = ResponseType.DEFAULT):
        ...
        if res_type == ResponseType.LIST and text:
